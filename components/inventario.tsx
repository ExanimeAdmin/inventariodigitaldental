...
export function Inventario({ usuarioClinicaId }: { usuarioClinicaId: string }) {
  ...
  const agregarProducto = () => {
    ...
    const productoCompleto: Producto = {
      ...
      guardado: false,
      clinicaId: usuarioClinicaId,
      refrigeracion: nuevoProducto.refrigeracion || false,
    }
  ...
  const seleccionarProductoCatalogo = (producto: any) => {
    setNuevoProducto({
      ...
      clinicaId: usuarioClinicaId,
      refrigeracion: producto.refrigeracion || false,
    })
    setResultadosBusqueda([])
    setTabActiva("manual")
  }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <input
                          type="checkbox"
                          id="refrigeracion"
                          checked={nuevoProducto.refrigeracion || false}
                          onChange={(e) => setNuevoProducto({ ...nuevoProducto, refrigeracion: e.target.checked })}
                          className="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                        />
                        <Label htmlFor="refrigeracion" className="text-sm font-medium text-gray-700">
                                ...
                                <TableRow key={producto.id}>
                                  <TableCell>
                                    <div className="flex items-center">
                                      {producto.nombre}
                                      {producto.refrigeracion && <Thermometer className="ml-2 h-4 w-4 text-blue-500" />}
                                    </div>
                                  </TableCell>
